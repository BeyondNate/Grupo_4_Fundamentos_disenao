...
*   **Aplicación móvil conectada vía WiFi/Bluetooth:** Interfaz principal que muestra inventario en tiempo real y envía notificaciones push:
...
| **Software** | OpenCV, TensorFlow Lite, App móvil (Flutter), Sistema de alertas | Procesamiento inteligente y comunicación |
...
| **Sensores** | Temperatura, humedad, peso, cámara |
